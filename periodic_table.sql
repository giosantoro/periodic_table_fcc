...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_elements UNIQUE (name, symbol);


--
-- Name: properties constraint_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT constraint_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties constraint_type_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT constraint_type_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
